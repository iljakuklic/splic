...
explicit decision: fix the code, or suppress with a targeted `#[allow(...)]`. A
`#[allow]` is not an admission of defeat — it is documentation that the flagged
pattern was reviewed and kept intentionally.
